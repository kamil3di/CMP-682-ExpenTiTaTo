    ...
    def start(self):
        ...
        while True:
            ...
            if self.mTurn % 2 == 0:
                ...
                print('Computer is selecting the rubric...')
            ...
            if gameResult.value != 'notEnd':
                ...
                if gameResult.value == 'Tie':
                    ...
                    if self.XsPoint > self.OsPoint:
                        print("The winner is X with extra" + str(self.XsPoint-self.OsPoint) + " point!")
                    elif self.OsPoint > self.XsPoint:
                        print("The winner is O with extra" + str(self.OsPoint-self.XsPoint) + " point!")
                    else:
                        print("There is no winner! The game is tie!")
                    sys.exit()
                else:
                    if self.mTurn % 2 == 0:
                        self.increase_point('x')
                        print('Your point is: ' + str(self.XsPoint))
                        print('Computers point is: ' + str(self.OsPoint))
                    else:
                        self.increase_point('o')
                        print('Your point is: ' + str(self.XsPoint))
                        print('Computers point is: ' + str(self.OsPoint))
